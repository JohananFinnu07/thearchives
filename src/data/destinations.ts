  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        makingProcess: 'Fresh green bamboo stems are cut and one end is sealed naturally. Marinated chicken with tribal spices is stuffed inside and the open end is sealed with leaves. The bamboo is placed over slow-burning coals for 2-3 hours, rotating regularly.',
        uses: ['Traditional cuisine', 'Tourist attraction', 'Special occasions', 'Cultural experience'],
        image: bambooChickenImage
      },
      {
        name: 'Koya Tribal Jewelry',
        type: 'underrated',
        description: 'Handcrafted beaded jewelry and metal ornaments made by Koya women using traditional techniques.',
        significance: 'Each piece of jewelry tells a story of the wearer\'s clan, marital status, and social position. The designs have remained unchanged for centuries and are an important cultural identifier.',
        makingProcess: 'Beads are strung on natural fiber threads in specific patterns taught from mother to daughter. Metal pieces are hammered and shaped using simple tools. Some incorporate forest seeds, shells, and animal teeth.',
        uses: ['Ceremonial wear', 'Daily adornment', 'Gifting', 'Cultural identity', 'Collector items'],
        image: dhokraArtImage
      },
      {
        name: 'Forest Turmeric',
        type: 'underrated',
        description: 'Potent wild turmeric harvested from the forest floors of Maredumilli, known for high curcumin content.',
        significance: 'Forest turmeric from Maredumilli has been tested to contain significantly higher curcumin levels than cultivated varieties. It\'s been used by tribal healers for centuries for its powerful anti-inflammatory properties.',
        makingProcess: 'Rhizomes are dug from forest soils during the dry season. They\'re cleaned, boiled in large pots for hours, then sun-dried on raised platforms. The dried fingers are ground in stone mills to preserve medicinal properties.',
        uses: ['Traditional medicine', 'Cooking spice', 'Beauty treatments', 'Religious rituals', 'Natural dye'],
        image: wildTurmericImage
      }
    ]
  }
